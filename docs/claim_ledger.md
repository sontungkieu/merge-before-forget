...
| C11 | Seeds | three random seeds; identities not reported | missing | Pre-registered 42/43/44 are complete; they cannot be asserted to match the paper's undisclosed seeds. |
| C12 | Qwen SuperNI target | SLAO O1 37.8, O2 32.4, avg 35.1 | specified | Kaggle O1 SLAO is 50.3136 ± 0.8334% over three seeds, +12.5136 pp and 33.10% target-relative above 37.8; outside the registered 5% tolerance, so the numeric paper row is not reproduced. |
