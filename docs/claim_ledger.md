...
| C11 | Seeds | three random seeds; identities not reported | missing | Pre-register 42/43/44; seed 42 is complete and seeds 43/44 remain pending. |
| C12 | Qwen SuperNI target | SLAO O1 37.8, O2 32.4, avg 35.1 | specified | Seed-42 O1 AA is 49.6031 (+11.8031 pp); defer the reproduction decision until three-seed aggregation. |
